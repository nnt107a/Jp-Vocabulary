...
js_header = """// Japanese Grammar Data (Trợ từ & Nghi vấn từ - Giáo trình Đông Du Sơ Cấp 1 & JLPT N5)
...
# Let's import the data lists from generate_grammar_data_final.py
from generate_grammar_data_final import particle_fill_list, interrogative_fill_list, sentence_translation_list, error_correction_list
...
print("Generated clean and valid js/grammar_data.js")
